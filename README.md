...
- Using matplotlib animation for visualization on the streaming data [vis_matplotlib_anim](/CodeRepository/vis_matplotlib_anim/)
- A web application run on Python Flask framework. The idea behind using a web application is to provide a user friendly approach to start and the view the results of the stream and query operation in a graphical manner [vis_flask_plotly](/CodeRepository/vis_flask_plotly/)
